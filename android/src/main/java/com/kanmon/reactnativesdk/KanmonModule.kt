...
class KanmonModule(private val reactContext: ReactApplicationContext) :
  ...
  private fun showModal(showArgs: String) {
      synchronized(webViewLock) {
        ...
        if (dialog == null) {
          dialog = Dialog(currentActivity!!, android.R.style.Theme_NoTitleBar_Fullscreen).apply {
        ...
        webChromeClient = object : WebChromeClient() {
          ...
          override fun onShowFileChooser(
            ...
            try {
              ...
              currentActivity?.startActivityForResult(Intent.createChooser(intent, "Select File"), FILE_PICKER_REQUEST_CODE)
            } catch (e: Exception) {
