...
class WebViewDialogFragment(private val reactContext: ReactContext) : DialogFragment() {
    companion object {
...
//    webView = initializeWebView(reactContext)
...
//    }
//
//    webView?.loadUrl(arguments?.getString("url") ?: "about:blank")
    // Wrap the WebView in a layout
  ...
  override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
    ...
    val dialog =  Dialog(requireContext(), android.R.style.Theme_NoTitleBar_Fullscreen).apply {
...
//                if (dialog == null) {
//                    dialog = Dialog(requireContext(), android.R.style.Theme_NoTitleBar_Fullscreen).apply {
//                        requestWindowFeature(Window.FEATURE_NO_TITLE)
//                        setContentView(R.layout.modal_webview)
//
//                        window?.apply {
